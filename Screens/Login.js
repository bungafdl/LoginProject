...
export class Login extends React.Component {
  render() {
    return(
      ...
      <Image style={{width:60, height: 100}} source={require('../lol.jpg')}/>
      <Text style={styles.logoText}>Welcome to Salty Spitoon</Text>
      <Text style={styles.logoText}>Seberapa Greget Anda</Text>
